...
export const AuctionsView = () => {
  ...
  switch (activeKey) {
      ...
      case LiveAuctionViewState.Participated:
        items = liveAuctions.concat(auctionsEnded).filter((m, idx) => m.myBidderMetadata?.info.bidderPubkey == publicKey?.toBase58());
        break;
            ...
            <>
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  await saveAdmin(connection, walletContext, false, [
